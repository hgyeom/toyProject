						...
						<c:forEach items = "${list}" var="contentDTO">
								<div class="col-md-12">
									<div class="blog-entry ftco-animate">
										<a href="<c:url value='content?content_id=${contentDTO.content_id}&page=${page}&pageSize=${pageSize}'/>" class="img" style="background-image: url(images/image_1.jpg);"></a>
							...
							<div class="block-27">
								<ul>
									<c:if test="${ph.showPrev}">
										<li><a href="<c:url value='study?page=${ph.beginPage-1}&pageSize=${ph.pageSize}'/>">&lt;</a></li>
									</c:if>
									<c:forEach var="i" begin="${ph.beginPage}" end="${ph.endPage}">
										<a href="<c:url value='study?page=${i}&pageSize=${ph.pageSize}'/>">
											<li class="active"><span>${i}</span></li>
										</a>
									</c:forEach>
									<c:if test="${ph.showNext}">
										<li><a href="<c:url value='study?page=${ph.endPage+1}&pageSize=${ph.pageSize}'/>">&gt;</a></li>
									</c:if>
								</ul>
							</div>
							<%--페이징--%>
