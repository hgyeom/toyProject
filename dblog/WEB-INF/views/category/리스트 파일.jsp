            ...
            <div class="row">
                ...
                <div class="col-lg-4 sidebar ftco-animate">
                    ...
                    <div class="sidebar-box ftco-animate">
                        ...
                        <ul class="categories">
                            <li><a href="diary.do">Diary <span>${countDiary}</span></a></li>
                            <li><a href="travel.do">Travel <span>${countTravel}</span></a></li>
                            <li><a href="study.do">Study <span>${countStudy}</span></a></li>
                        </ul>
                    </div>
                    <%-- 사이드바 메뉴
                                    <div class="sidebar-box ftco-animate">
